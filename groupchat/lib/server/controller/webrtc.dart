...
import 'package:groupchat/server/controller/controller.dart';
  ...
  Future<void> createWebRtcConnection(
    ...
    if (connectionType == 'secondary') {
      ...
      controller.appStates.clientList.value[clientIndex].clientStream!
          .getTracks()
          .forEach(
            (track) => controller.appStates.connections.value[index].pc!
                .addTrack(
                    track,
                    controller
                        .appStates.clientList.value[clientIndex].clientStream!),
          );
    } else {
    ...
    controller.appStates.connections.value[index].pc!.onConnectionState =
      ...
      if (state == RTCPeerConnectionState.RTCPeerConnectionStateConnected &&
        ...
        for (var i = 0; i < controller.appStates.clientList.value.length; i++) {
          print(
